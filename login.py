...
class Login_Window:
    def __init__(self, root):
        ...
        #Login Buttton
        loginbutton=Button(frame,command=self.login,text="Login",font=("times new roman",15,"bold"),bd=3,relief=RIDGE,fg="white",bg="red",activforeground="white",activebackground="red")
        loginbutton.place(x=110,y=300,width=120,height=35)

        #Register Buttton
        loginbutton=Button(frame,text="New user register",font=("times new roman",15,"bold"),borderwidth=0,fg="white",bg="black",activforeground="white",activebackground="red")
