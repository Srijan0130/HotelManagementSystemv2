...
class HotelManagementSystem:
    def __init__(self, root):
        ...
        # title
        lbl_title = Label(self.root, text="HOTEL MANAGEMENT SYSTEM", font=("times new roman", 40, "bold"), bg="dark green",
        ...
        # menu
        lbl_menu = Label(main_frame, text="MENU", font=("times new roman", 20, "bold"), bg="dark green",
                         fg="white", bd=4, relief=RIDGE)
        ...
        cust_btn = Button(btn_frame, text="CUSTOMER", command=self.cust_details, width=22, font=("times new roman", 14, "bold"), bg="dark green",
                          fg="white", bd=0, cursor="hand1")
        cust_btn.grid(row=0, column=0, pady=1)

        room_btn = Button(btn_frame, text="ROOM", width=22, command=self.roombooking, font=("times new roman", 14, "bold"), bg="dark green",
                          fg="white", bd=0, cursor="hand1")
        room_btn.grid(row=1, column=0, pady=1)

        details_btn = Button(btn_frame, text="DETAILS", width=22, command=self.details, font=("times new roman", 14, "bold"), bg="dark green",
                             fg="white", bd=0, cursor="hand1")
        details_btn.grid(row=2, column=0, pady=1)

        report_btn = Button(btn_frame, text="REPORT", width=22, font=("times new roman", 14, "bold"), bg="dark green",
                            fg="white", bd=0, cursor="hand1")
